...
<body>
    <div class="bg-gradient-custom w-full min-h-screen flex items-center justify-center py-4 px-3">
        <div class="card-glass relative rounded-2xl p-5 sm:p-6 animate-pop-in animate-fade-in-up">
            ...
            <div class="space-y-2 animate-fade-in-up delay-4">
                <a href="{{ route('auth.google') }}" class="btn-google w-full flex items-center justify-center gap-2.5 py-2 px-4 rounded-xl text-sm font-semibold transition-all duration-200">
                ...
                <a href="{{ route('auth.facebook.redirect') }}" class="btn-facebook w-full flex items-center justify-center gap-2.5 py-2 px-4 rounded-xl text-sm font-semibold transition-all duration-200">
