{{-- Ajoutez ce bloc dans le <head> de votre layout, ou utilisez @push('styles') --}}
@push('styles')
    <link href="https://fonts.googleapis.com/css2?family=Inter:ital,wght@0,400;0,500;0,600;0,700;1,400&display=swap" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <style>
        /* Applique la police Google à toute la page */
        body {
...
<div class="max-w-3xl mx-auto">
    <div class="bg-white rounded-2xl shadow-xl p-8 card-animate">
        ...
        <form method="POST" action="{{ route('admin.admins.store') }}" autocomplete="off">
            ...
            {{-- Statut --}}
            <div class="form-floating field-7">
...
{{-- Script pour l'effet ripple sur le bouton --}}
@push('scripts')
<script>
