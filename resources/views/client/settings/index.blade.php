    ...
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-xl shadow-md p-4">
                ...
                <ul class="space-y-1">
                    ...
                    <li>
                        <a href="/client/settings/password" class="flex items-center px-3 py-2 rounded-lg hover:bg-gray-50 text-gray-700 transition">
        ...
        <div class="lg:col-span-3 space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <a href="/client/settings/password" class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition flex items-center justify-between group">
                    <div>
