...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="bg-white rounded-xl shadow-md p-4 mb-6">
        <form method="GET" action="{{ route('client.reservations.index') }}" id="filterForm" class="flex flex-wrap gap-4 items-end">
            <div class="flex-1 min-w-[150px]">
                ...
                <select name="statut" id="statut" class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div class="flex-1 min-w-[200px]">
                ...
                <div class="relative">
                    <input type="text" name="search" id="search" value="{{ request('search') }}" placeholder="Code voyage ou ID..." class="w-full border border-gray-300 rounded-lg px-3 py-2 pl-9 focus:outline-none focus:ring-2 focus:ring-blue-500">
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden">
        ...
        <div class="px-6 py-3 border-b border-gray-200 text-sm text-gray-500">
            <i class="fas fa-list mr-1"></i> {{ $reservations->total() }} réservation(s) trouvée(s)
        </div>
        @endif
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase"><i class="fas fa-door-open mr-1"></i>Pavillon</th>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase"><i class="fas fa-coins mr-1"></i>Prix</th>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 transition">
                        ...
                        <td class="px-6 py-4 text-sm text-gray-700">{{ $reservation->pavillon->nom ?? 'N/A' }}</td>
                        ...
                        <td class="px-6 py-4 text-sm">
                            ...
                            <form action="{{ route('client.reservations.destroy', $reservation->id) }}" method="POST" class="inline" onsubmit="return confirm('Annuler cette réservation ? Cette action est irréversible.');">
                                @csrf
                                @method('DELETE')
        ...
        <div class="md:hidden divide-y divide-gray-200">
            ...
            <div class="p-4 hover:bg-gray-50 transition">
                ...
                <div class="mt-2 grid grid-cols-2 gap-1 text-sm text-gray-600">
                    <p><span class="font-medium">Pavillon :</span> {{ $reservation->pavillon->nom ?? 'N/A' }}</p>
